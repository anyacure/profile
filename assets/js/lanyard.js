    ...
    try {
      ...
      if (data.success) {
        ...
        if (discord.discord_user && discord.discord_user.avatar) {
          ...
          // Sync Avatar Frame live from Lanyard data
          const avatarFrame = document.getElementById('avatar-frame');
          if (avatarFrame) {
            let asset = null;
            if (discord.discord_user.avatar_decoration_data && discord.discord_user.avatar_decoration_data.asset) {
              asset = discord.discord_user.avatar_decoration_data.asset;
            } else if (discord.discord_user.avatar_decoration && discord.discord_user.avatar_decoration.asset) {
              asset = discord.discord_user.avatar_decoration.asset;
            }
            
            if (asset) {
              avatarFrame.src = `https://cdn.discordapp.com/avatar-decoration-presets/${asset}.png?size=256&passthrough=true`;
        ...
        statusText.textContent = "24/7 miss you";
